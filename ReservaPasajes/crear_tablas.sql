...
create table app.servicios(ser_id integer, ser_origen char(50), ser_destino char(50), ser_empresa_prestadora char(50), ser_numero_asiento integer, ser_hora_salida char(5), ser_fecha_salida char(10), ser_descr_tipo_serv char(20), ser_precio decimal(10,2) );
